...
# <img src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExNTljeGk4d3lzZnU3Mm1peDBienFpbmEyb3JmaDB5N21tMW9oczIwdyZlcD12MV9zdGlja2Vyc19zZWFyY2gmY3Q9cw/8p1WPEOeDWFCksfe18/giphy.gif" width="45">  VPN-конфигурации, работающие в РФ 
...
### ВНИМАНИЕ ПОЛЬЗОВАТЕЛЯМ APPLE! Касается тех, кто до сих пор сидит в Российском AppStore! 

С 1 апреля Минцифры приказало МТС, Билайну и Мегафону и Т2 отключить опцию пополнения Apple-ID с мобильного счета! То есть пропадет возможность оплачивать ваши подписки, облако и так далее. Чтобы избежать перебоев с подписками, до 31 марта включительно пополните свой Apple-ID примерно на сумму, которую вы тратите за полгода-год всех подписок Apple вместе взятых! За это время вы сможете без нервов переключиться из Российского AppStore на любой другой, например AppStore "Беларуси" / "Казахстана" / "Соединенных Штатов", либо любой другой страны, оформить и привязать местную карту!

Серьезно задумывайтесь о переезде из Российского на любой другой иностранный, поскольку цензура вынуждает Apple удалять из AppStore все, чего она боится. На днях были удалены клиенты Streisand, V2RayTune, V2Box, Happ и даже старенький всеми забытый Psiphon, который я публиковал тут в альтернативных способах обхода несколько недель назад. В AppStore других стран все доступно как и раньше!

Что делать, чтобы сменить регион? В магазине Appstore нажмите на значок профиля, потом на свое имя, введите пароль Apple-ID, появится меню, там выберите "Страна/регион" и поменяйте на "Беларусь" / "Казахстан" / "Соединенные Штаты" или что вам удобно. При смене региона потребуется сменить способ оплаты, то есть нужна будет карта того региона, который вы выбрали, но иногда не требуется, проверяйте, зависит от страны. Карта для оплаты нужна будет физическая местная или виртуальная, попросите родственников, друзей или просто закажите услугу за деньги, сейчас много кто этим занимается.

*Не поддавайтесь давлению цензуры, используйте любые способы обхода, пока вы сопротивляетесь - она бессильна!*
...
<details>
<summary> Нажмите, чтобы проверить обновления </summary>
